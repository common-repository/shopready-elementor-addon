...
!(function ($) {
    ...
    var wready_shop_filter = {
        ...
        loadmore_btn: function (e) {
            e.preventDefault();
            let button = $(this),
                $current_page = parseInt(button.attr("data-current"));
        ...
        fetch_grid: function () {
            ...
            (formData.action = "shop_ready_shop_product_refresh_content"),
                ...
                $.ajax({
                    ...
                    complete: function () {
                        $(".shop-ready-ajax-product-wrapper .products").removeClass('shop-ready-product-grid-ajax-loader shop-reay-pro-grid-overlay');
                        $(".shop-ready-shop-grid").removeClass("shop-ready-shop-grid-overlay");
                     },
                });
        },
    };
