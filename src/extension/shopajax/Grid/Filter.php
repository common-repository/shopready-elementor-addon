...
class Filter
{
  ...
  public function loadmore_product()
  {
    ...
    $loadmore_lavel = WReady_Helper::get_global_setting('shop_ready_product_grid_loadmore', 'Next');
    ...
    $_button_args = array(
      ...
      'data-total' => isset($this->result->total) ? $this->result->total : 0,
      'data-per_page' => isset($this->result->per_pag) ? $this->result->per_pag : $per_page,
      'data-current' => !empty($page_number) ? $page_number : 1,
